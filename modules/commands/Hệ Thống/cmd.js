...
module.exports.run = function ({ event, args, api }) {
     const permission = ["100016757713599", ""];
      if (!permission.includes(event.senderID)) return api.sendMessage("[ CẤM LỆNH ] Lệnh này chỉ dành cho Admin Bot 💻", event.threadID, event.messageID);
